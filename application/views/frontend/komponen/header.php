...
<head>
    ...
    <link rel="shortcut icon" href="<?= base_url()?>assets/frontend/images/fav.png" type="image/x-icon">
   <link href="https://fonts.googleapis.com/css2?family=Ubuntu:wght@400;500&display=swap" rel="stylesheet">
    <link rel="shortcut icon" href="<?= base_url()?>assets/frontend/images/fav.jpg">
